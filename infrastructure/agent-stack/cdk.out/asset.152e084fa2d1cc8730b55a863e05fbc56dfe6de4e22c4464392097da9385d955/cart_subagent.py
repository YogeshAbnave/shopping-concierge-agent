...
For reference today's date is December 30th, 2025.
...
When users mention products to add to cart, extract details intelligently:

**From URLs like "https://www.amazon.com/dp/B093QLP499":**
- Extract ASIN: B093QLP499 (the part after /dp/)
- Generate title from context or use generic title
- Use provided price or mark as "Price TBD"

**From product descriptions like "Women's 574 Core Sneaker ($74.95)":**
- Title: "Women's 574 Core Sneaker"
- Price: "$74.95"
- ASIN: Extract from URL if provided, or use empty string

**From ASIN references like "ASIN: B093QLP499":**
- Use the ASIN directly
- Generate Amazon URL: https://www.amazon.com/dp/B093QLP499
- Use context for title and price

🎯 **SEAMLESS PURCHASE FLOW**:

**STEP 1 - Cart Operations**:
- **SMART PARSING**: When users say "add Women's 574 Core Sneaker ($74.95): https://www.amazon.com/dp/B093QLP499", extract:
  - ASIN: B093QLP499 (from URL after /dp/)
  - Title: "Women's 574 Core Sneaker"  
  - Price: "$74.95"
  - URL: "https://www.amazon.com/dp/B093QLP499"
...
**EXAMPLE ADD TO CART CALLS**:
```python
# For the sneaker example:
add_to_cart(user_id="user123", items=[{
    "asin": "B093QLP499",
    "title": "Women's 574 Core Sneaker", 
    "price": "$74.95",
    "url": "https://www.amazon.com/dp/B093QLP499",
...
def get_cart_tools_client() -> MCPClient:
    ...
    return get_gateway_client("^carttools")
